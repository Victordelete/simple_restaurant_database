...
CREATE TABLE IF NOT EXISTS ORDEM_COMPRA(
    ...
    ALTER TABLE ORDEM_COMPRA ADD CONSTRAINT FK_ORDEM_COMPRA_TO_FUNCIONARIO FOREIGN KEY(ID_FUNCIONARIO)
	REFERENCES FUNCIONARIO(ID_FUNCIONARIO) ON DELETE CASCADE;

    ALTER TABLE ORDEM_COMPRA ADD CONSTRAINT FK_ORDEM_COMPRA_TO_FORNECEDOR FOREIGN KEY(ID_FORNECEDOR)
...
CREATE TABLE IF NOT EXISTS LISTA_PRODUTOS_COMPRA(
    ...
    ALTER TABLE LISTA_PRODUTOS_COMPRA ADD CONSTRAINT FK_PRODUTOS_COMPRA_TO_ORDEM_COMPRA FOREIGN KEY(ID_ORDEM_COMPRA)
	REFERENCES ORDEM_COMPRA(ID_ORDEM_COMPRA) ON DELETE CASCADE;
    
    ALTER TABLE LISTA_PRODUTOS_COMPRA ADD CONSTRAINT FK_PRODUTOS_COMPRA_TO_MATERIA_PRIMA FOREIGN KEY(ID_MATERIA_PRIMA)
