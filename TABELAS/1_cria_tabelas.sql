...
/*CONSTRAINT QUE RELACIONA O FUNCIONARIO AO SEU RESPECTIVO DEPARTAMENTO*/
 ALTER TABLE FUNCIONARIO ADD CONSTRAINT FK_FUNCIONARIO_DEPARTAMENTO FOREIGN KEY (ID_DEPARTAMENTO)
...
CREATE TABLE IF NOT EXISTS LISTA_PONTO(
	...
	ALTER TABLE LISTA_PONTO ADD CONSTRAINT FK_LISTA_PONTO_TO_FUNCIONARIO FOREIGN KEY(ID_FUNCIONARIO)
