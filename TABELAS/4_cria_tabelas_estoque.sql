...
CREATE TABLE IF NOT EXISTS ITEM_MENU(
    ...
    ALTER TABLE ITEM_MENU ADD CONSTRAINT FK_ITEM_MENU_TO_CATEGORIA FOREIGN KEY(ID_CATEGORIA)
...
CREATE TABLE IF NOT EXISTS DEMANDA(
    ...
    ALTER TABLE DEMANDA ADD CONSTRAINT FK_DEMANDA_TO_ITEM_MENU FOREIGN KEY(ID_ITEM_MENU)
	REFERENCES ITEM_MENU(ID_ITEM_MENU) ON DELETE CASCADE;
    
    ALTER TABLE DEMANDA ADD CONSTRAINT FK_DEMANDA_TO_MATERIA_PRIMA FOREIGN KEY(ID_MATERIA_PRIMA)
